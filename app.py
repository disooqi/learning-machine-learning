...
if __name__ == '__main__':
    ...
    mnist = MNIST_dataset(handwritten_digits['X'].T, handwritten_digits['y'].T, dev_size=0.05)
    ...
    # nn01.add_layer(25, activation='relu', dropout_keep_prob=.6)
    nn01.add_layer(50, activation='relu', dropout_keep_prob=.5)
    nn01.add_output_layer()

    nn01.train(epochs=600, mini_batch_size=0, alpha=0.2, regularization_parameter=5)
    print('tra acc:', nn01.accuracy(mnist.X_train, mnist.y_train))
